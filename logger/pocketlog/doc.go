...
First, instantiate a logger with pocketlog.New, and giving it a
threshold level.
...
The logger can be called to log messages on three levels:
  ...
  - Warn: messages to warn about potential issues
  - Error: error messages to understand what went wrong
  - Fatal: fatal messages to understand what went wrong and stop the program
*/
package pocketlog
